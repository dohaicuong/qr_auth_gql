...
export type TaskDocketListPaginationQuery$variables = {
  count?: number | null;
  cursor?: string | null;
  id: string;
};
export type TaskDocketListPaginationQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"TaskDocketList_me">;
  } | null;
};
export type TaskDocketListPaginationQuery = {
  response: TaskDocketListPaginationQuery$data;
  variables: TaskDocketListPaginationQuery$variables;
};
